                        ...
                        <div class="card-actions">
                            <button type="button" class="btn btn-outline" 
                                ...
                                data-time="/ 12 hours"
                                 ...
                                 data-booked="{{ in_array('Standard Room ' . $i, $bookedRooms) ? 'true' : 'false' }}">View Details</button>
                            @if(in_array("Standard Room " . $i, $bookedRooms))
                            ...
                            @else
                                <a href="{{ route('booking.form.full', ['room' => 'Standard Room ' . $i]) }}" class="btn">Book Now</a>
                            @endif
                        </div>
                    </div>
                </div>
